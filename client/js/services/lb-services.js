  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Item.entries.findById() instead.
        "prototype$__findById__entries": {
          url: urlBase + "/Items/:id/entries/:fk",
          method: "GET"
        },

        // INTERNAL. Use Item.entries.destroyById() instead.
        "prototype$__destroyById__entries": {
          url: urlBase + "/Items/:id/entries/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Item.entries.updateById() instead.
        "prototype$__updateById__entries": {
          url: urlBase + "/Items/:id/entries/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Item.entries() instead.
        "prototype$__get__entries": {
          isArray: true,
          url: urlBase + "/Items/:id/entries",
          method: "GET"
        },

        // INTERNAL. Use Item.entries.create() instead.
        "prototype$__create__entries": {
          url: urlBase + "/Items/:id/entries",
          method: "POST"
        },

        // INTERNAL. Use Item.entries.destroyAll() instead.
        "prototype$__delete__entries": {
          url: urlBase + "/Items/:id/entries",
          method: "DELETE"
        },

        // INTERNAL. Use Item.entries.count() instead.
        "prototype$__count__entries": {
          url: urlBase + "/Items/:id/entries/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Category.items.findById() instead.
        "::findById::Category::items": {
          url: urlBase + "/Categories/:id/items/:fk",
          method: "GET"
        },

        // INTERNAL. Use Category.items.destroyById() instead.
        "::destroyById::Category::items": {
          url: urlBase + "/Categories/:id/items/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Category.items.updateById() instead.
        "::updateById::Category::items": {
          url: urlBase + "/Categories/:id/items/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Category.items() instead.
        "::get::Category::items": {
          isArray: true,
        ...
        // INTERNAL. Use Category.items.create() instead.
        "::create::Category::items": {
          url: urlBase + "/Categories/:id/items",
          method: "POST"
        },

        // INTERNAL. Use Category.items.destroyAll() instead.
        "::delete::Category::items": {
          url: urlBase + "/Categories/:id/items",
          method: "DELETE"
        },

        // INTERNAL. Use Category.items.count() instead.
        "::count::Category::items": {
          url: urlBase + "/Categories/:id/items/count",
          method: "GET"
        },

        // INTERNAL. Use Entry.item() instead.
        "::get::Entry::item": {
          url: urlBase + "/Entries/:id/item",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Item.entries
     * @header lbServices.Item.entries
     * @object
     * @description
     *
     * The object `Item.entries` groups methods
     * manipulating `Entry` instances related to `Item`.
     *
     * Call {@link lbServices.Item#entries Item.entries()}
     * to query all related instances.
     */
        ...
        R.entries = function() {
          ...
          var action = TargetResource["::get::Item::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.entries#count
         * @methodOf lbServices.Item.entries
         *
         * @description
         *
         * Counts entries of Item.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.entries.count = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::count::Item::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.entries#create
         * @methodOf lbServices.Item.entries
         *
         * @description
         *
        ...
        R.entries.create = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::create::Item::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.entries#destroyAll
         * @methodOf lbServices.Item.entries
         *
         * @description
         *
        ...
        R.entries.destroyAll = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::delete::Item::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.entries#destroyById
         * @methodOf lbServices.Item.entries
         *
         * @description
         *
        ...
        R.entries.destroyById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::destroyById::Item::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.entries#findById
         * @methodOf lbServices.Item.entries
         *
         * @description
         *
        ...
        R.entries.findById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::findById::Item::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.entries#updateById
         * @methodOf lbServices.Item.entries
         *
         * @description
         *
        ...
        R.entries.updateById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::updateById::Item::entries"];
          return action.apply(R, arguments);
        };
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Category.items
     * @header lbServices.Category.items
     * @object
     * @description
     *
     * The object `Category.items` groups methods
     * manipulating `Item` instances related to `Category`.
     *
     * Call {@link lbServices.Category#items Category.items()}
     * to query all related instances.
     */
        ...
        R.items = function() {
          ...
          var action = TargetResource["::get::Category::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Category.items#count
         * @methodOf lbServices.Category.items
         *
         * @description
         *
         * Counts items of Category.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.items.count = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::count::Category::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Category.items#create
         * @methodOf lbServices.Category.items
         *
         * @description
         *
        ...
        R.items.create = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::create::Category::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Category.items#destroyAll
         * @methodOf lbServices.Category.items
         *
         * @description
         *
        ...
        R.items.destroyAll = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::delete::Category::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Category.items#destroyById
         * @methodOf lbServices.Category.items
         *
         * @description
         *
        ...
        R.items.destroyById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::destroyById::Category::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Category.items#findById
         * @methodOf lbServices.Category.items
         *
         * @description
         *
        ...
        R.items.findById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::findById::Category::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Category.items#updateById
         * @methodOf lbServices.Category.items
         *
         * @description
         *
        ...
        R.items.updateById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::updateById::Category::items"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Order.entries.findById() instead.
        "prototype$__findById__entries": {
          url: urlBase + "/Orders/:id/entries/:fk",
          method: "GET"
        },

        // INTERNAL. Use Order.entries.destroyById() instead.
        "prototype$__destroyById__entries": {
          url: urlBase + "/Orders/:id/entries/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Order.entries.updateById() instead.
        "prototype$__updateById__entries": {
          url: urlBase + "/Orders/:id/entries/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Order.entries() instead.
        "prototype$__get__entries": {
          isArray: true,
          url: urlBase + "/Orders/:id/entries",
          method: "GET"
        },

        // INTERNAL. Use Order.entries.create() instead.
        "prototype$__create__entries": {
          url: urlBase + "/Orders/:id/entries",
          method: "POST"
        },

        // INTERNAL. Use Order.entries.destroyAll() instead.
        "prototype$__delete__entries": {
          url: urlBase + "/Orders/:id/entries",
          method: "DELETE"
        },

        // INTERNAL. Use Order.entries.count() instead.
        "prototype$__count__entries": {
          url: urlBase + "/Orders/:id/entries/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Entry.order() instead.
        "::get::Entry::order": {
          url: urlBase + "/Entries/:id/order",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Order.entries
     * @header lbServices.Order.entries
     * @object
     * @description
     *
     * The object `Order.entries` groups methods
     * manipulating `Entry` instances related to `Order`.
     *
     * Call {@link lbServices.Order#entries Order.entries()}
     * to query all related instances.
     */
        ...
        R.entries = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::get::Order::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.entries#count
         * @methodOf lbServices.Order.entries
         *
         * @description
         *
         * Counts entries of Order.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.entries.count = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::count::Order::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.entries#create
         * @methodOf lbServices.Order.entries
         *
         * @description
         *
        ...
        R.entries.create = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::create::Order::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.entries#destroyAll
         * @methodOf lbServices.Order.entries
         *
         * @description
         *
        ...
        R.entries.destroyAll = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::delete::Order::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.entries#destroyById
         * @methodOf lbServices.Order.entries
         *
         * @description
         *
        ...
        R.entries.destroyById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::destroyById::Order::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.entries#findById
         * @methodOf lbServices.Order.entries
         *
         * @description
         *
        ...
        R.entries.findById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::findById::Order::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Order.entries#updateById
         * @methodOf lbServices.Order.entries
         *
         * @description
         *
        ...
        R.entries.updateById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::updateById::Order::entries"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Item.entries.findById() instead.
        "::findById::Item::entries": {
          url: urlBase + "/Items/:id/entries/:fk",
          method: "GET"
        },

        // INTERNAL. Use Item.entries.destroyById() instead.
        "::destroyById::Item::entries": {
          url: urlBase + "/Items/:id/entries/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Item.entries.updateById() instead.
        "::updateById::Item::entries": {
          url: urlBase + "/Items/:id/entries/:fk",
          method: "PUT"
        },
        ...
        // INTERNAL. Use Order.entries.findById() instead.
        "::findById::Order::entries": {
          url: urlBase + "/Orders/:id/entries/:fk",
          method: "GET"
        },

        // INTERNAL. Use Order.entries.destroyById() instead.
        "::destroyById::Order::entries": {
          url: urlBase + "/Orders/:id/entries/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Order.entries.updateById() instead.
        "::updateById::Order::entries": {
          url: urlBase + "/Orders/:id/entries/:fk",
          method: "PUT"
        },
    ...
    */
    R.modelName = "Entry";
        ...
        R.order = function() {
          var TargetResource = $injector.get("Order");
          var action = TargetResource["::get::Entry::order"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Entry#item
         * @methodOf lbServices.Entry
         *
         * @description
         *
        ...
        R.item = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::get::Entry::item"];
          return action.apply(R, arguments);
        };
